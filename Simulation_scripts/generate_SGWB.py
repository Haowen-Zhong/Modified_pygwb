...
H_Noise = TimeSeries.read(f'./Frames/Pure_Noise/H-STRAIN-{st}-2048.gwf', "H1:TEST_INJ", st, st+2048)
L_Noise = TimeSeries.read(f'./Frames/Pure_Noise/L-STRAIN-{st}-2048.gwf', "L1:TEST_INJ", st, st+2048)

H_data = H_data + H_Noise
L_data = L_data + L_Noise

H_data.write(f'./Frames/Noisy_SGWB/alpha_0_Omega_5e-12/H-STRAIN-{st}-2048.gwf')
L_data.write(f'./Frames/Noisy_SGWB/alpha_0_Omega_5e-12/L-STRAIN-{st}-2048.gwf')